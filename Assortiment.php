  <body>
    ...
    ?>
      ...
      <h1 class="display-4">Vuurpijlen</h1>
    </div>
    <div class="container">
      <div class="card-deck mb-3 text-center">
        ...
        <div class="card-header">
          ...
          <div class="card-body">
            ...
            <button onclick="location.href=;" type="button" class="btn btn-lg btn-block btn-outline-primary">In winkelwagen</button>
          </div>
        </div>'.$i. '<div class="card mb-4 shadow-sm">
          <div class="card-header">
            <h4 class="my-0 font-weight-normal">Red star selection</h4>
            <h6 class="my-0 font-weight-normal">Vuurwerk pakket</h6>
          </div>
